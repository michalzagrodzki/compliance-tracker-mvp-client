...
const formatRecommendationContent = (text: string) => {
  ...
  while (currentIndex < lines.length) {
    ...
    // Handle numbered implementation steps
...
const formatImplementationStep = (lines: string[], startIndex: number) => {
  ...
  // Look for timeline and sub-bullets
        ...
        {bullets.map((bullet, idx) => (
          <li key={idx} className="flex items-start space-x-2 text-sm text-gray-700">
            ...
            <span className="leading-relaxed">
              {formatInlineContent(bullet.replace(/^-\s*/, '').replace(/^\s*-\s*/, ''))}
            </span>
          </li>
        ))}
      </ul>
                ...
                <div>
                  <div className="p-4 bg-gray-100 border border-gray-300 rounded-md">
                    <div className="prose prose-sm max-w-none">
                      {formatRecommendationContent(currentReport.executive_summary)}
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center space-x-2">
                  ...
                  <span>Control Risk Prioritization</span>
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
                  <div className="p-4 bg-gray-100 border border-gray-300 rounded-md">
                    <div className="prose prose-sm max-w-none">
                      {formatRecommendationContent(currentReport.control_risk_prioritization)}
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  <div className="p-4 bg-gray-100 border border-gray-300 rounded-md">
                    <div className="prose prose-sm max-w-none">
                      {formatRecommendationContent(currentReport.threat_intelligence_analysis)}
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  <div className="p-4 bg-gray-100 border border-gray-300 rounded-md">
                    <div className="prose prose-sm max-w-none">
                      {formatRecommendationContent(currentReport.target_audience_summary)}
                    </div>
                  </div>
                </div>
              </CardContent>
